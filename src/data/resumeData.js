export const resumeData = {
  en: {
    ...
    projects: [
      "Lung cancer prediction by factors and behavior (Nov 2022 - Mar 2023)",
      "Comparative Study on ML and DL Models in Predicting Football Match Outcomes (Jan 2025 - Mar 2025)",
      "Text Processing of Sunthorn Phu's Poetry for Corpus Construction and Automatic Poem Generation (Nov 2024 - Mar 2025)",
      "Bigmall Plus WMS website developer (July 2025 - Present)"
    ],
    awards: [
    ...
    sections: {
      ...
      experience: "🚀 Professional Evolution",
  ...
  th: {
    ...
    education: [
      ...
      {
        degree: "Fullstack Developer & IT support & Data Analyst",
        institution: "บริษัท Bigmall Plus",
        period: "มิถุนายน 2568 - ปัจจุบัน"
      }
    ],
    experience: [
      "หัวหน้าฝ่ายสันทนาการ (2564)",
      "หัวหน้าฝ่ายสันทนาการ (2565)",
      "ประธานสโมสรนักศึกษา (2566)",
      "ที่ปรึกษาสโมสรนักศึกษา (2567)",
      "Fullstack Developer & IT support & Data Analyst (2568)"
    ],
    projects: [
      "การทำนายโรคมะเร็งปอดจากปัจจัยและพฤติกรรม (พ.ย. 2565 - มี.ค. 2566)",
      "การศึกษาเปรียบเทียบโมเดล ML และ DL ในการทำนายผลการแข่งขันฟุตบอล (ม.ค. 2568 - มี.ค. 2568)",
      "การประมวลผลข้อความกวีนิพนธ์ของสุนทรภู่เพื่อสร้างคลังข้อมูลและการสร้างบทกวีอัตโนมัติ (พ.ย. 2567 - มี.ค. 2568)",
      "นักพัฒนาเว็บไซต์ระบบ WMS ของ Bigmall Plus (ก.ค. 2568 - ปัจจุบัน)"
    ],
    awards: [
      { title: "รางวัลกิจกรรมดีเด่น", year: "2566" },
      { title: "รางวัลกิจกรรมดีเด่น", year: "2567" }
    ],
    sections: {
